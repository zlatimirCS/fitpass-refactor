...
const HeroHomeCustom = ({ item }: { item: any }) => {
  return (
      ...
      <div className='wrapper'>
        <div className='hero-top'>
          <h1>
            ...
            {item?.sliderTitleLine2 && <span>{item.sliderTitleLine2}</span>}
            {item?.sliderTitleLine3 && (
              <span className='big bold'>{item.sliderTitleLine3}</span>
            )}
            {item?.sliderSubTitleLine1 && (
              <span className='bold'>{item.sliderSubTitleLine1}</span>
            )}
            {item?.sliderSubTitleLine2 && (
              <span className='bold'>{item.sliderSubTitleLine2}</span>
            )}
          </h1>
        </div>
...
export default memo(HeroHomeCustom);
